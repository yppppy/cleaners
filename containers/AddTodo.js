...
import { addTodo,decTodo,updateText } from '../actions/index.js'  
    ...
    render() {  
      ...
      return (  
        <View style={styles.container}>  
          <TouchableHighlight style={styles.itemView} underlayColor="red" onPress={()=>{this.props.store.dispatch(addTodo(num))}}>  
              <Text style={styles.itemText}>  
                点击我就+1  
              </Text>  
          </TouchableHighlight>  
  
          <TouchableHighlight style={styles.itemView} underlayColor="red" onPress={()=>{this.props.store.dispatch(decTodo(num))}}>  
              <Text style={styles.itemText}>  
                点击我就-1  
              </Text>  
          </TouchableHighlight>  
